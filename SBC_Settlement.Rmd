...
setwd("~/Documents/SBC_Settlement_Analysis/")
...
ggplot(data = p_species_brm_st5, aes(x = Temp_top_Z, y = spur_plus_1, color = Species)) +
  geom_point(size = .5,) +
  geom_smooth(method = "loess", span = 1, fullrange = TRUE) +
  theme_classic(base_size = 20, base_rect_size = 0) +
  theme(legend.position = "none") +
